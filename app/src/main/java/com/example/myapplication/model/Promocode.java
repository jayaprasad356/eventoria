...
public class Promocode {
    String id,promo_code,message,start_date,end_date,no_of_users,minimum_order_amount,discount,max_discount_amount,no_of_repeat_usage,date_created,status;
    public Promocode(){

    }

    public Promocode(String id, String promo_code, String message, String start_date, String end_date, String no_of_users, String minimum_order_amount, String discount, String max_discount_amount, String no_of_repeat_usage, String date_created, String status) {
        this.id = id;
